...
public class BattleActionLoader {
    public static final int 
            ...
            BRAVERY=300,SHELTER=301, FRAILTY=302,WEAKNESS=303, SEAR=304,
            RAISEGUARD = 400, ENRAGE=401;

    public static BattleAction loadAction(int actionID){
        switch(actionID){
            case FIRE       :return new DamageSpell(actionID,"Flame","deals 5-10 Fire damage",5,5,Element.FIRE,5);
            case WATER      :return new DamageSpell(actionID,"Frost","deals 5-10 Water damage",5,5,Element.WATER,5);
            case EARTH      :return new DamageSpell(actionID,"Quake","deals 5-10 Earth damage",5,5,Element.EARTH,5);
            case WIND       :return new DamageSpell(actionID,"Gust","deals 5-10 Air damage",5,5,Element.AIR,5);
            case LIGHT      :return new DamageSpell(actionID,"Shine","deals 5-10 Light damage",5,5,Element.LIGHT,8);
            case DARK       :return new DamageSpell(actionID,"Shade","deals 5-10 Dark damage",5,5,Element.DARK,8);
            ...
            case BRAVERY    :return new EffectSpell(actionID,"Brave","25% Str buff",10,Effect.loadStatAltering(Effect.BUFF, "Bravery", "Bravery", 5, BattleEntity.STR, .25));
            case SHELTER    :return new EffectSpell(actionID,"Guard","25% Vit buff",10,Effect.loadStatAltering(Effect.BUFF, "Shelter", "Shelter", 5, BattleEntity.VIT, .25));
            case WEAKNESS    :return new EffectSpell(actionID,"Weaken","25% Str debuff",10,Effect.loadStatAltering(Effect.DEBUFF, "Enfeeble", "Enfeeble", 5, BattleEntity.STR, .25));
            case FRAILTY    :return new EffectSpell(actionID,"Frail","25% Vit debuff",10,Effect.loadStatAltering(Effect.DEBUFF, "Frailty", "Frailty", 5, BattleEntity.VIT, .25));
